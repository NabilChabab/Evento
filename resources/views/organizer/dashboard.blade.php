                                ...
                                <div class="row">
                                    <div class="col-8">
                                        <div class="numbers">
                                            ...
                                            <p class="mb-0">
                                                <span
                                                    class="text-success text-sm font-weight-bolder">nasjahdj</span>
                                                2 years ago
                                            </p>
                                        </div>
                                    </div>
                                    <div class="col-4 text-end">
                                        <div
                                            ...
                                            <a href=""><img src="{{ asset('images/avatar.jpg')}}" alt=""
                                                srcset=""
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <div class="text-center">
                                                    ...
                                                    <h6 class="text-sm mb-0"><span class="text-success">$ </span>aaaaaa</h6>
                                                </div>
                                            </td>
                                            <td>
                                                <div class="text-center">
                                        ...
                                        <li class="list-group-item border-0 d-flex justify-content-between ps-0 mb-2 border-radius-lg" style="background-color:#161718;">
                                            <div class="d-flex align-items-center">
                                                <div class="icon icon-shape icon-sm me-3 bg-gradient-dark shadow text-center">
                                                    <img src="{{ asset('images/bg.jfif') }}" alt="" style="width: 40px;height:40px;border-radius:10px;">
                                                </div>
                                            ...
                                            <div class="d-flex">
                                                    <a href="#"><img src="{{asset('images/avatar.jpg')}}"  style="width: 40px;height:40px;border-radius:10px;"></a>
                                            </div>
                                        </li>
